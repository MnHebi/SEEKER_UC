 ...
 * @author Tartiflette
 */
public class SKR_neutrinoDetector_item extends BaseSpecialItemPlugin{
	...
	public void performRightClickAction() {
                ...
                if (player.getAbilities().contains(SKR_ids.ABILITY_NEUTRINO_DETECTOR)) return;

                // Unlock the ability and replace the corresponding vanilla ability
                player.addAbility(SKR_ids.ABILITY_NEUTRINO_DETECTOR);
