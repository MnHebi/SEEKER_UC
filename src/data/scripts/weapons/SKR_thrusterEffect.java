...
public class SKR_thrusterEffect implements EveryFrameWeaponEffectPlugin {
...
//            if(thruster!=null){
//                size.scale(thruster.getHitpoints()/190);
//            }
            ...
            THRUST_TO_TURN=MagicAnim.smooth(MathUtils.getDistance(SHIP.getLocation(), weapon.getLocation())/SHIP.getCollisionRadius());            
        }
            ...
            if(thrust>0){
                ...
                if(!turn){
                    ...
                    if(!accel){                        
                        ...
                        clampedThrustToTurn=MagicAnim.smooth(clampedThrustToTurn);
