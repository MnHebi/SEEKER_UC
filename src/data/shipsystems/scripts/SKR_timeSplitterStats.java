...
public class SKR_timeSplitterStats extends BaseShipSystemScript {
    public final float MAX_TIME_MULT = 10f;

    public final Color JITTER_COLOR = new Color(90,165,255,55);
    public final Color JITTER_UNDER_COLOR = new Color(90,165,255,155);
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        float shipTimeMult = MAX_TIME_MULT * ship.getMutableStats().getSystemRegenBonus().getBonusMult();
        shipTimeMult = 1f + (shipTimeMult - 1f) * effectLevel;
...
//            player = ship == Global.getCombatEngine().getPlayerShip();
    ...
    private final String TIME = txt("timeStop");
    @Override
